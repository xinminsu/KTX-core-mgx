...
contract Timelock is ITimelock {
    ...
    uint256 public constant MAX_FUNDING_RATE_FACTOR = 200000; // 0.02%
    ...
    function initRewardRouter() external onlyAdmin {
        ...
        IHandlerTarget(_rewardRouter.feeGlpTracker()).setHandler(
            rewardRouter,
            true
        );
        IHandlerTarget(_rewardRouter.stakedGlpTracker()).setHandler(
            rewardRouter,
            true
        );
    ...
    function setShortsTrackerAveragePriceWeight(
        ...
        IGlpManager(glpManager).setShortsTrackerAveragePriceWeight(
